...
export interface AMMTokenPairInterface extends Interface {
  getFunction(
    nameOrSignature:
      | "DOMAIN_SEPARATOR"
      | "MINIMUM_LIQUIDITY"
...
export interface AMMTokenPair extends BaseContract {
  connect(runner?: ContractRunner | null): AMMTokenPair;
  waitForDeployment(): Promise<this>;

  interface: AMMTokenPairInterface;
