...
export interface AMMRouter01Interface extends Interface {
  getFunction(
    nameOrSignature:
      | "WETH"
      | "addLiquidity"
...
export interface AMMRouter01 extends BaseContract {
  connect(runner?: ContractRunner | null): AMMRouter01;
  waitForDeployment(): Promise<this>;

  interface: AMMRouter01Interface;
  ...
  initialize: TypedContractMethod<
    [_factoryAddr: AddressLike, _WETHAddr: AddressLike],
    [void],
    "nonpayable"
  >;
