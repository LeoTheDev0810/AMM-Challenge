...
export interface IAMMRouter01Interface extends Interface {
  getFunction(
    nameOrSignature:
      | "WETH"
      | "addLiquidity"
...
export interface IAMMRouter01 extends BaseContract {
  connect(runner?: ContractRunner | null): IAMMRouter01;
  waitForDeployment(): Promise<this>;

  interface: IAMMRouter01Interface;
